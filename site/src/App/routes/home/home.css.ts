...
/**
 * Escapes the centered maxWidth container. Expects the content to be centered and free of the sidebar.
 * Dark brand band (seekBlue 700) in both color modes — matches SEEK branded surfaces.
 */
