...
const SkeletonLoader = () => (
  ...
  >
    ...
    <List>
      <Text>
        Size, layout, and spacing of skeleton elements should replicate the
        size, layout, and spacing of actual content where possible.
      </Text>
      <Text>
        Skeleton elements representing text and icons should be fully rounded
        using <Strong>borderRadius=&quot;full&quot;</Strong>.
      </Text>
      <Text>
        All other skeleton elements should replicate component rounding, for
        example a button or badge using{' '}
        <Strong>borderRadius=&quot;standard&quot;</Strong>.
      </Text>
      <Text>
        Colour for all skeleton elements should be <Strong>neutralLight</Strong>{' '}
    ...
    <Text>
      Avoid animation. A standardised approach to skeleton animation can be
      considered when capacity allows.
    </Text>
    ...
    <List>
      ...
      <Text>
        Ensure skeletons are screen-reader accessible and work as expected in
        dark mode.
      </Text>
      <Text>
        Scale skeletons to reflect changes in content size and density on small
        screens.
      </Text>
      <Text>Show skeletons only as long as needed.</Text>
      <Text>Keep skeleton code lightweight to avoid slowing load times.</Text>
    </List>

    <LinkableHeading>When to use</LinkableHeading>
    <Text>Use skeletons for:</Text>
    <List>
      <Text>Areas of content that are likely to have longer load times</Text>
      <Text>
        Essential or prominent content like job ads, candidate profiles, or
        recommended jobs
      </Text>
      <Text>
    ...
    <List>
      <Text>
        Small, low-priority elements (for example icons or secondary elements)
      </Text>
      <Text>
        Minimal or overly simple layouts — use the{' '}
        <TextLink href="/components/Loader">Loader</TextLink> component instead
      </Text>
      <Text>
        Page-to-page transitions, especially in single-page apps where skeletons
      ...
      <Text>
        ...
        <TextLink href="/patterns/empty-states">empty state</TextLink> instead
      </Text>
      <Text>
        When the website or app fails to complete an expected action — use an{' '}
    ...
    <List>
      <Text>
        <TextLink href="/components/Loader">Loader</TextLink> — For indicating
        that content is loading in a more minimal way
      </Text>
      <Text>
...
export default patternPage('skeleton-loader', <SkeletonLoader />);
