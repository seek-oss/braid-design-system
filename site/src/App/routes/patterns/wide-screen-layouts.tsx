...
const WideScreenLayouts = () => (
  <PatternLayout
    slug="wide-screen-layouts"
    description="Braid components allow you to create and tailor your page widths and layouts to meet your customers' needs. Whilst infinite variation is possible, the width and layout of content and pages should be carefully considered as they have a significant impact on readability, scanability, and how adaptable products are across different devices."
    sections={[
      { href: '#best-practice', label: 'Best practice' },
      {
  ...
  >
    <LinkableHeading>Best practice</LinkableHeading>
    <List>
      <Text>
      ...
      <Text>
        Ensure wide-screen layouts adapt to smaller screens by stacking content
        or moving it to a separate area (for example a drawer, sheet or page)
      </Text>
    ...
    <List>
      <Text>
        <TextLink href="/components/PageBlock">PageBlock</TextLink> — Provides a
        top-level page container, constraining the content width while
        maintaining common screen gutters on smaller devices
      </Text>
      <Text>
      ...
      <Text>
        <TextLink href="/components/Columns">Columns</TextLink> — For creating
        horizontal layouts that work for your product
      </Text>
      <Text>
      ...
      <Text>
        <TextLink href="/components/Tiles">Tiles</TextLink> — For laying out a
        collection of elements that wrap across a product-determined number of
        columns
      </Text>
      <Text>
        <TextLink href="/components/Drawer">Drawer</TextLink> — For housing
        content that benefits from a focused view or that can&rsquo;t be stacked
        on smaller screens
      </Text>
      <Text>
        <TextLink href="/foundations/layout">Layout components</TextLink> — All
        available components needed to create an infinite variety of content and
        page layouts
      </Text>
    </List>

    <LinkableHeading>Examples</LinkableHeading>
    <Text>
      The examples below are a small sample of wide-screen layouts. The
      principles can be combined to meet your particular requirements. Resize
      the browser window to see how they adapt.
    </Text>

    <LinkableHeading level="3">
      1. Full-width responsive — collapsing to stack
    </LinkableHeading>
    <List>
    ...
    <LinkableHeading level="3">
      2. Full-width responsive — moving content to a drawer
    </LinkableHeading>
    <List>
      <Text>Content runs full width on all screen sizes</Text>
      <Text>
        Sections that can&rsquo;t be stacked on smaller screens can be moved to
        a drawer or separate page
      </Text>
    </List>
    <PlayroomExample
    ...
    <LinkableHeading level="3">3. Full-width horizontal scroll</LinkableHeading>
    <List>
      <Text>Content runs full width on all screen sizes</Text>
      <Text>Content scrolls horizontally on all screen sizes</Text>
      <Text>Ideal for connected horizontal content, such as Kanban boards</Text>
    </List>
    <PlayroomExample
      Example={() =>
        source(
    ...
    <LinkableHeading level="3">4. Constrained max width</LinkableHeading>
    <List>
      <Text>
        The page extends to a maximum width determined by the product team as
        optimal for their experience
      </Text>
      <Text>
    ...
    <LinkableHeading level="3">5. Full width split view</LinkableHeading>
    <List>
      <Text>Content area is divided into summary and detail</Text>
      <Text>
        Summary cards can wrap from two columns on wide screens to one column on
        smaller screens
      </Text>
      <Text>
    ...
    <LinkableHeading level="3">6. Responsive grid layout</LinkableHeading>
    <List>
    ...
    <LinkableHeading>ContentBlock and PageBlock</LinkableHeading>
    <Text>
      Use <Strong>PageBlock</Strong> as the top-level page container, then nest{' '}
      <Strong>ContentBlock</Strong> when a nested section needs a narrower
      measure — for example body copy inside a full-width layout.
    </Text>
  </PatternLayout>
);

export default patternPage('wide-screen-layouts', <WideScreenLayouts />);
