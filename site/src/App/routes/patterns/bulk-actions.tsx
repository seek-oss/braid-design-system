...
export const docs: PatternDocs = {
  description: <Text>Apply the same action to multiple items at once.</Text>,
  additional: [
    {
      label: 'Appearance',
      description: (
        <Text>
          ...
          <TextLink href="/components/ButtonIcon">ButtonIcons</TextLink>). Below
          is an example of bulk actions in isolation, followed by an example in
          the context of a{' '}
    ...
    },
    {
      ...
      description: (
        <List>
          <Text>
            Use a <Strong>CheckboxStandalone</Strong> for selection and provide
            each with an <Strong>aria-label</Strong> or{' '}
            <Strong>aria-labelledby</Strong> property to maintain accessibility.
          </Text>
    ...
    },
    {
      ...
      description: (
        <List>
          ...
          <Text>
            <TextLink href="/patterns/divided-lists">Divided lists</TextLink> —
