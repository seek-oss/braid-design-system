...
const BulkActions = () => (
  <PatternLayout
    ...
    sections={[
      ...
      { href: '#in-context-example', label: 'In context example' },
  ...
  >
    ...
    <Text>
      ...
      <TextLink href="/components/Checkbox#standalone">Checkboxes</TextLink>{' '}
      with{' '}
      ...
      <TextLink href="/components/ButtonIcon">ButtonIcons</TextLink>). Below is
      an example of bulk actions in isolation, followed by an example in the
      context of a{' '}
    ...
    <LinkableHeading>In context example</LinkableHeading>
    <Text>Bulk actions in a Divided List:</Text>
    <PlayroomExample
      Example={({
        setDefaultState,
        getState,
    ...
    <List>
      <Text>
        Use a <Strong>CheckboxStandalone</Strong> for selection and provide each
        with an <Strong>aria-label</Strong> or <Strong>aria-labelledby</Strong>{' '}
      ...
      <Text>
        Avoid surfacing bulk actions when no selection is made. This keeps the
        UI clean by reducing unnecessary clutter.
      </Text>
      <Text>
        If an action requires the user to confirm, such as a destructive action
        like “Delete”, consider surfacing this within a{' '}
        <TextLink href="/components/Dialog">Dialog</TextLink>.
      </Text>
      <Text>
        Once an action has been completed, consider surfacing a{' '}
        <TextLink href="/components/useToast">Toast</TextLink> confirmation
        message.
      </Text>
    </List>
    ...
    <List>
      <Text>
        <TextLink href="/components/Checkbox">Checkbox</TextLink> — To allow
      ...
      <Text>
        <TextLink href="/patterns/divided-lists">Divided lists</TextLink> — To
        display a group of related items consecutively in an organised way
      </Text>
    </List>
  </PatternLayout>
);

export default patternPage('bulk-actions', <BulkActions />);
