...
const ServiceOutageBanners = () => (
  <PatternLayout
    slug="service-outage-banners"
    sections={[
      { href: '#general-best-practice', label: 'General best practice' },
      { href: '#widespread-disruptions', label: 'Widespread disruptions' },
      { href: '#isolated-disruptions', label: 'Isolated disruptions' },
      {
        href: '#stacking-multiple-banners',
  ...
  >
    ...
    <Text>
      ...
      communications. Ideally, the customer would have heard about the outage
      before arriving on platform. The outage banner should serve as a reminder,
      rather than be the first news of the outage.
    </Text>

    <LinkableHeading>Widespread disruptions</LinkableHeading>
    <Text>
      Take this approach when the disruption to service impacts entire systems
      or products. This includes, but isn&rsquo;t limited to, site-wide
      maintenance, product outages and overdue accounts.
    </Text>
    <PlayroomExample
    ...
    <Text>
      ...
      messaging. Create a custom component and follow the recommendations below.
    </Text>
    <List>
      <Text>
        Choose an appropriate{' '}
        <TextLink href="/foundations/tones">tone</TextLink> for your banner and
        use the corresponding icon. Critical: high risk and/or urgency (for
        example, the system will be unavailable). Caution: lower risk and/or
        urgency (for example, the system will be slower than usual). Info:
        functional, calm and non-urgent (for example, the system is updating in
        the background). Critical and caution are usually the most relevant
        tones for outage messaging — consider these before reaching for info.
      </Text>
      <Text>
      ...
      <Text>
        ...
        <TextLink href="/components/Dialog">Dialog</TextLink> when relevant.
      </Text>
      <Text>
        Align the banner look and feel to the latest{' '}
        <TextLink href="/components/Alert">Alert</TextLink> component style, but
        do not round the corners.
      </Text>
      <Text>
        Widespread disruption banners should remain constant, without the option
        for the user to dismiss them.
      </Text>
    </List>
    <Text>
    ...
    <List>
      ...
      <Text>
        ...
        example <Strong>criticalLight</Strong>, <Strong>cautionLight</Strong> or{' '}
        <Strong>infoLight</Strong>.
      </Text>
      <Text>
      ...
      <Text>
        Left-align the banner text and wrap it in a centre-aligned Stack so icon
        spacing stays uniform.
      </Text>
    </List>

    <LinkableHeading>Isolated disruptions</LinkableHeading>
    <Text>
    ...
    <List>
      ...
      <Text>
        Choose an appropriate tone. Critical and caution are usually the most
        relevant for outage messaging.
      </Text>
      <Text>
      ...
      <Text>
        Isolated disruption banners should generally remain constant. If your
        scenario warrants a dismissible banner, Alert supports this via{' '}
        <Strong>onClose</Strong>.
      </Text>
    </List>

    <LinkableHeading>Stacking multiple banners</LinkableHeading>
    <Text>When you need to show multiple outage banners on the same page:</Text>
    <PlayroomExample
      Example={({ getState, toggleState, setDefaultState }) =>
        source(
          <>
    ...
    <List>
      <Text>
        Widespread outage banners should sit at the very top of the page — above
        the site navigation.
      </Text>
      <Text>
    ...
    <LinkableHeading>Content guidelines</LinkableHeading>
    <Text>
      Use specific, calm copy. Say what is unavailable, when it is affected, and
      what to do next. Avoid alarmist language.
    </Text>
    <Text>
    ...
    <Text>
      Our site isn&rsquo;t available right now. We&rsquo;re doing our best to
      fix this. Try refreshing the page or check back later.
    </Text>
    <Text>
      <Strong>Planned, isolated</Strong>
    </Text>
    <Text>
      We&rsquo;re improving our site. Your ad performance reports will not be
      available until 11 am, Friday 13 Jan 2023. Sorry for any inconvenience. If
      you need help, reach out to our Customer Service team.
    </Text>
    <Text>
      <Strong>Unplanned, isolated</Strong>
    </Text>
    <Text>
      Your ad performance reports aren&rsquo;t available right now. We&rsquo;re
      doing our best to fix this. Try refreshing the page or check back later.
      If it still doesn&rsquo;t work, reach out to our Customer Service team.
    </Text>
    <Text>
      <Strong>Slow or intermittent service</Strong>
    </Text>
    <Text>
      We&rsquo;re improving our site. Posting a job ad may be slower than usual
      until 11 am, Friday 13 Jan 2023. Sorry for any inconvenience. If you need
      help, reach out to our Customer Service team.
    </Text>
  </PatternLayout>
);

export default patternPage('service-outage-banners', <ServiceOutageBanners />);
