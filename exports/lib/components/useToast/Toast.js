...
const Action = function Action(_ref) {
...
const Toast = /* #__PURE__*/React.forwardRef(function (_ref2, ref) {
  const id = _ref2.id,
  ...
  const content = description ? /* #__PURE__*/_jsx(Stack, {
    space: "xxsmall"
