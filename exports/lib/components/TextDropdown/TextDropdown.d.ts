...
export declare function parseSimpleToComplexOption<Value>(
  option: TextDropdownProps<Value>['options'][number],
): TextDropdownOption<Value>;
export declare function TextDropdown<Value>({
  id,
  value,
  onChange,
  onBlur,
  ...
  label,
  data,
}: TextDropdownProps<Value>): JSX.Element;
export {};
