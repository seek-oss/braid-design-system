...
export function TextDropdown(_ref) {
  ...
  const _parsedOptions$filter = parsedOptions.filter(function (o) {
  ...
  if (!currentText || !currentText.text) {
    throw new Error(
      'The provided value of "'.concat(
        value,
        '" does not exist in the provided `options` list.',
      ),
    );
  }
  ...
  return /* #__PURE__*/ React.createElement(
    ...
    /* #__PURE__*/ _jsx(
      ...
      /* #__PURE__*/ _jsx(
        ...
        void 0,
        parsedOptions.map(function (option) {
