...
const useStackItem = function useStackItem(_ref) {
...
const extractHiddenPropsFromChild = function extractHiddenPropsFromChild(
  child,
) {
  return child &&
...
const resolveHiddenProps = function resolveHiddenProps(_ref2) {
  const screen = _ref2.screen,
    above = _ref2.above,
    below = _ref2.below;
  return screen
    ? [true, true, true]
...
const calculateHiddenStackItemProps = function calculateHiddenStackItemProps(
  stackItemProps,
  _ref3,
) {
  const _ref4 = _slicedToArray(_ref3, 3),
  ...
  const _normalizedValue$mobi = normalizedValue.mobile,
    displayMobile =
      _normalizedValue$mobi === void 0 ? 'block' : _normalizedValue$mobi,
    _normalizedValue$tabl = normalizedValue.tablet,
    displayTablet =
      _normalizedValue$tabl === void 0 ? displayMobile : _normalizedValue$tabl,
    _normalizedValue$desk = normalizedValue.desktop,
    displayDesktop =
      _normalizedValue$desk === void 0 ? displayTablet : _normalizedValue$desk;
  return _objectSpread(
    _objectSpread({}, stackItemProps),
    {},
    {
...
export var Stack = function Stack(_ref5) {
  ...
  const _ref5$component = _ref5.component,
  ...
  const stackItemProps = useStackItem({
    space,
    align,
  });
  ...
  return /* #__PURE__*/ React.createElement(
    ...
    Children.map(stackItems, function (child, index) {
      assert(
        !(
          _typeof(child) === 'object' &&
          child.type === Hidden &&
          child.props.inline !== undefined
        ),
      ...
      const _hidden = _slicedToArray(hidden, 3),
