...
let _selectors2, _selectors3;

import * as __vanilla_filescope__ from '@vanilla-extract/css/fileScope';

__vanilla_filescope__.setFileScope(
  'lib/components/iconButtons/IconButton.css.ts',
  'braid-design-system',
);
...
export var hoverOverlay = style(
  {
    selectors:
      ...
      _defineProperty(
        _selectors2,
        ''.concat(button, ':hover &, ').concat(button, ':focus &'),
        {
          opacity: 1,
        },
      ),
      ...
      _defineProperty(
        _selectors2,
        ''.concat(button, ':active &, ').concat(forceActive, '&'),
        {
          opacity: 0.8,
        },
      ),
...
export var focusOverlay = style(
  {
    selectors:
      ((_selectors3 = {}),
      _defineProperty(_selectors3, ''.concat(button, ':focus &'), {
        opacity: 1,
      }),
      _defineProperty(
        _selectors3,
        ''.concat(button, ':focus &').concat(darkBackground),
        {
          opacity: 0.15,
        },
      ),
