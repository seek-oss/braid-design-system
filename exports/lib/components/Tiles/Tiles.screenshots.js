...
export var screenshots = {
  ...
  examples: [].concat(
    _toConsumableArray(
      [1, 2, 3, 4, 5, 6].map(function (columns) {
        return {
          ...
          Example: function Example() {
            return /* #__PURE__*/ _jsx(
              ...
              void 0,
              _toConsumableArray(new Array(columns * exampleRows)).map(
                function (_, i) {
                  return /* #__PURE__*/ _jsx(
                    Placeholder,
                    {
    ...
    [
      {
        ...
        Example: function Example() {
          return /* #__PURE__*/ _jsx(
            ...
            void 0,
            _toConsumableArray(new Array(4 * exampleRows)).map(function (_, i) {
              return /* #__PURE__*/ _jsx(
                Placeholder,
                {
                  height: 40,
      ...
      },
      {
        ...
        Example: function Example() {
          return /* #__PURE__*/ _jsx(
            ...
            void 0,
            _toConsumableArray(new Array(2 * exampleRows)).map(function (_, i) {
              return /* #__PURE__*/ _jsx(
                Box,
                {
                  background: 'card',
                ...
                i,
                _Text ||
                  (_Text = /* #__PURE__*/ _jsx(Text, {}, void 0, 'Tile')),
              );
            }),
          );
        },
          ...
          return /* #__PURE__*/ _jsx(
            ...
            _toConsumableArray(new Array(2 * exampleRows)).map(function (_, i) {
              return /* #__PURE__*/ _jsx(
                ...
                i,
                _Text2 ||
                  (_Text2 = /* #__PURE__*/ _jsx(Text, {}, void 0, 'Tile')),
              );
            }),
          );
        },
