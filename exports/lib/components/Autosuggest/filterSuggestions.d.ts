...
declare type FilterableSuggestion<Value> = Omit<
  Suggestion<Value>,
  'highlights'
>;
declare type FilterableGroupedSuggestions<Value> = Omit<
...
declare type FilterableSuggestions<Value> = Array<
  FilterableSuggestion<Value> | FilterableGroupedSuggestions<Value>
>;
declare function filterSuggestions<Value>(
