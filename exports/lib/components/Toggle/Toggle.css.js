...
__vanilla_filescope__.setFileScope(
  'lib/components/Toggle/Toggle.css.ts',
  'braid-design-system',
);
...
const toggleWidthRatio = 1.6; // Reset the z-index at the parent level to scope
...
export var realFieldPosition = styleVariants(
  sizes,
  function (size) {
    return {
      top: calc(hitArea)
...
export var label = styleVariants(
  sizes,
  function (size) {
...
export var fieldSize = styleVariants(
  sizes,
  function (size) {
    return {
...
export var slideContainerSize = styleVariants(
  sizes,
  function (size) {
    return {
...
export var slideTrack = styleVariants(
  sizes,
  function (size) {
    return {
...
export var slideTrackSelected = style(
  {
    selectors: _defineProperty(
      {},
      ''
        .concat(realField, ':not(:checked) + ')
        .concat(slideContainerBase, ' &'),
      {
...
export var slider = styleVariants(
  sizes,
  function (size) {
    let _selectors2;
    ...
    return {
      ...
      selectors:
        ...
        _defineProperty(
          _selectors2,
          ''.concat(realField, ':active + ').concat(slideContainerBase, ' &'),
          {
        ...
        _defineProperty(
          _selectors2,
          ''.concat(realField, ':checked + ').concat(slideContainerBase, ' &'),
          {
        ...
        _defineProperty(
          _selectors2,
          ''
            .concat(realField, ':active:checked + ')
            .concat(slideContainerBase, ' &'),
          {
            transform: 'translateX('.concat(
              calc.add(slideDistance, anticipation),
              ')',
            ),
          },
        ),
...
export var focusOverlay = style(
  {
    selectors: _defineProperty(
      {},
      ''
        .concat(realField, ':focus + ')
        .concat(slideContainerBase, ' &, ')
        .concat(realField, ':active + ')
        .concat(slideContainerBase, ' &'),
      {
        opacity: 1,
      },
...
export var hoverOverlay = style(
  {
    selectors: _defineProperty(
      {},
      ''
        .concat(realField, ':hover:not(:disabled) + ')
        .concat(slideContainerBase, ' &'),
      {
        opacity: 1,
      },
