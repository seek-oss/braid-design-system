...
export var makeThemeUtils = function makeThemeUtils(tokens) {
  const makeMediaQuery = function makeMediaQuery(breakpoint) {
    return function (styles) {
      return !styles || Object.keys(styles).length === 0 ? {} : _defineProperty({}, "screen and (min-width: ".concat(tokens.breakpoint[breakpoint], "px)"), styles);
    };
  };
  ...
  const responsiveStyle = function responsiveStyle(_ref2) {
