...
export declare type TextBreakpoint = Exclude<Breakpoint, 'desktop'>;
declare type FontSizeText = {
    fontSize: number;
    rows: number;
};
export declare type TextDefinition = Record<TextBreakpoint, FontSizeText>;
declare type FontWeight = 'regular' | 'medium' | 'strong';
