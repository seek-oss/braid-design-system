...
const _excluded = ["fontSize", "lineHeight"],
...
const fontSizeToCapHeight = function fontSizeToCapHeight(grid, definition, fontMetrics) {
  ...
  const _buildValues = buildValues({
    fontSize: mobile.fontSize,
  ...
  const _buildValues2 = buildValues({
    fontSize: tablet.fontSize,
