...
__vanilla_filescope__.setFileScope("lib/hooks/typography/typography.css.ts", "braid-design-system");
...
const makeTypographyRules = function makeTypographyRules(textDefinition, debug) {
  const _textDefinition$mobil = textDefinition.mobile,
  ...
  const _textDefinition$table = textDefinition.tablet,
...
const makeTouchableSpacing = function makeTouchableSpacing(touchableHeight, textHeight) {
