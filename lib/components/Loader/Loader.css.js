...
__vanilla_filescope__.setFileScope("lib/components/Loader/Loader.css.ts", "braid-design-system");

import { composeStyles, keyframes, style, styleVariants } from '@vanilla-extract/css';
import { responsiveStyle } from '../../atoms/responsiveStyle';
import { vars } from '../../themes/vars.css';
export var rootSize = styleVariants(vars.textSize, function (_ref) {
...
export var size = styleVariants(vars.textSize, function (_ref2) {
...
var animationDelayInMs = 70;
export var circle = composeStyles(bounceAnimation, style({
  transform: "translateY(1.4em)",
  selectors: (_selectors = {}, _defineProperty(_selectors, "&:nth-child(1)", {
