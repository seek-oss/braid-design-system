...
export var Heading = function Heading(_ref) {
  var level = _ref.level,
      ...
      data = _ref.data;
  return /*#__PURE__*/_jsx(HeadingContext.Provider, {
    value: true
  ...
  }, data ? buildDataAttributes(data) : undefined), truncate ? /*#__PURE__*/_jsx(Truncate, {}, void 0, children) : children));
};
