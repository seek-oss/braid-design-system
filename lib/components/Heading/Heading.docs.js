...
let _Stack, _Heading, _Heading2, _Heading3, _Heading4, _Heading5, _Heading6;
  ...
  additional: [
    {
      ...
      description: /* #__PURE__*/ _jsx(
        ...
        ' ',
        'will render an ',
        /* #__PURE__*/ _jsx(Strong, {}, void 0, 'h2'),
        ' element. If you need the semantics to be different from the visuals, you can provide the desired HTML tag via the ',
    ...
    },
    {
      ...
      description: /* #__PURE__*/ _jsx(
        ...
        {},
        void 0,
        'Headings can be aligned via the ',
