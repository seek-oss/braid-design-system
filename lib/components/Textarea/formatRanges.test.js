...
describe('formatRanges', function () {
  it('should return the unformatted text if no highlighting is required', function () {
    var value = 'aaaaaaaaa bbbbbbbbbb';
    var ranges = [{
      start: 30
    }];
  ...
  it('should handle out of order ranges', function () {
    var value = 'some text some text some text some text';
    var ranges = [{
      start: 20,
      end: 24
    }, {
  ...
  it('should handle overlapping ranges', function () {
    var value = 'some text some text some text some text some text';
    var ranges = [{
      start: 0,
      end: 4
    }, {
