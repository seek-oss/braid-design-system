  ...
  additional: [
    ...
    },
    {
      ...
      description: /* #__PURE__*/ _jsx(
        ...
        ' ',
        /* #__PURE__*/ _jsx(Strong, {}, void 0, 'onClose'),
        ' handler.',
      ),
      Example: function Example() {
        return (
    ...
    },
    {
      ...
      description: /* #__PURE__*/ _jsx(
        ...
        ', the Alert\u2019s outline is omitted since the background has sufficient contrast without it.',
      ),
      Example: function Example() {
        return source(
          _Card ||
