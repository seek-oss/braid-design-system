...
> = {
  ...
  ghost: {
    default: {
      ...
      backgroundHoverClassName: atoms({ background: 'formAccentLighter' }),
      backgroundActiveClassName: atoms({
        background: 'formAccentLighterActive',
      }),
    ...
    brandAccent: {
      ...
      backgroundContext: undefined,
      backgroundClassName: undefined,
      backgroundHoverClassName: atoms({ background: 'brandAccentLighter' }),
      backgroundActiveClassName: atoms({
        background: 'brandAccentLighterActive',
      }),
    ...
    critical: {
      ...
      backgroundContext: undefined,
      backgroundClassName: undefined,
      backgroundHoverClassName: atoms({ background: 'criticalLighter' }),
      backgroundActiveClassName: atoms({ background: 'criticalLighterActive' }),
  ...
  soft: {
    default: {
      textTone: 'formAccent',
      backgroundContext: 'formAccentLighter',
      backgroundClassName: atoms({ background: 'formAccentLighter' }),
      backgroundHoverClassName: atoms({ background: 'formAccentLighterHover' }),
      backgroundActiveClassName: atoms({
        background: 'formAccentLighterActive',
      }),
      boxShadow: undefined,
    ...
    brandAccent: {
      textTone: 'brandAccent',
      backgroundContext: 'brandAccentLighter',
      backgroundClassName: atoms({ background: 'brandAccentLighter' }),
      backgroundHoverClassName: atoms({
        background: 'brandAccentLighterHover',
      }),
      backgroundActiveClassName: atoms({
        background: 'brandAccentLighterActive',
      }),
    ...
    critical: {
      textTone: 'critical',
      backgroundContext: 'criticalLighter',
      backgroundClassName: atoms({ background: 'criticalLighter' }),
      backgroundHoverClassName: atoms({ background: 'criticalLighterHover' }),
      backgroundActiveClassName: atoms({ background: 'criticalLighterActive' }),
      boxShadow: undefined,
    },
  },
