...
> = {
  ...
  ghost: {
    default: {
      ...
      backgroundHoverClassName: styles.softBackgrounds.formAccent,
      backgroundActiveClassName: styles.softBackgrounds.formAccentActive,
    ...
    brandAccent: {
      ...
      backgroundContext: undefined,
      backgroundClassName: undefined,
      backgroundHoverClassName: styles.softBackgrounds.brandAccent,
      backgroundActiveClassName: styles.softBackgrounds.brandAccentActive,
    ...
    critical: {
      ...
      backgroundContext: undefined,
      backgroundClassName: undefined,
      backgroundHoverClassName: styles.softBackgrounds.critical,
      backgroundActiveClassName: styles.softBackgrounds.criticalActive,
  ...
  soft: {
    default: {
      textTone: 'formAccent',
      backgroundContext: 'UNKNOWN_LIGHT',
      backgroundClassName: styles.softBackgrounds.formAccent,
      backgroundHoverClassName: styles.softBackgrounds.formAccentHover,
      backgroundActiveClassName: styles.softBackgrounds.formAccentActive,
      boxShadow: undefined,
    },
    brandAccent: {
      textTone: 'brandAccent',
      backgroundContext: 'UNKNOWN_LIGHT',
      backgroundClassName: styles.softBackgrounds.brandAccent,
      backgroundHoverClassName: styles.softBackgrounds.brandAccentHover,
      backgroundActiveClassName: styles.softBackgrounds.brandAccentActive,
      boxShadow: undefined,
    },
    critical: {
      textTone: 'critical',
      backgroundContext: 'UNKNOWN_LIGHT',
      backgroundClassName: styles.softBackgrounds.critical,
      backgroundHoverClassName: styles.softBackgrounds.criticalHover,
      backgroundActiveClassName: styles.softBackgrounds.criticalActive,
      boxShadow: undefined,
    },
  },
