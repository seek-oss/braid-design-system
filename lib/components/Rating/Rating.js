...
var getPercent = function getPercent(rating, position) {
...
var RatingStar = function RatingStar(_ref) {
  ...
  var currentBg = useBackground();

  var _useIcon = useIcon(restProps),
      className = _useIcon.className,
      iconProps = _objectWithoutProperties(_useIcon, _excluded2);

  var component = IconStarEmptySvg;
  ...
  return /*#__PURE__*/React.createElement(Box, _extends({
    ...
    className: [className, _defineProperty({}, styles.starColor, currentBg === 'body' || currentBg === 'card')]
  }));
};

RatingStar.displayName = "RatingStar";

var ratingArr = _toConsumableArray(Array(5));
...
export var Rating = function Rating(_ref3) {
  var rating = _ref3.rating,
      ...
      showTextRating = _ref3$showTextRating === void 0 ? true : _ref3$showTextRating,
  ...
  return /*#__PURE__*/_jsx(Text, {
    ...
    display: "inlineBlock",
    "aria-label": ariaLabel || "".concat(rating.toFixed(1), " out of ").concat(ratingArr.length)
  }, void 0, ratingArr.map(function (_, position) {
    return /*#__PURE__*/_jsx(Box, {
      display: "inlineBlock",
      "aria-hidden": true,
      className: _defineProperty({}, styles.starSpacing, position !== ratingArr.length - 1)
    }, position, /*#__PURE__*/_jsx(RatingStar, {
      percent: getPercent(rating, position)
    }));
  })), showTextRating && /*#__PURE__*/_jsx(Box, {
    component: "span",
    className: styles.textSpacing,
    "aria-hidden": true
  }, void 0, rating.toFixed(1)));
};
