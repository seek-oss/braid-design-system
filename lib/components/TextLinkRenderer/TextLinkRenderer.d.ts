...
export declare const PrivateTextLinkRenderer: (props: PrivateTextLinkRendererProps) => JSX.Element;
...
export declare const TextLinkRenderer: (props: PrivateTextLinkRendererProps) => JSX.Element;
export {};
