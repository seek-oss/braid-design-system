...
export declare type BackgroundVariant = NonNullable<BoxProps['background']> | 'UNKNOWN_DARK' | 'UNKNOWN_LIGHT';
export declare const BackgroundProvider: React.Provider<BackgroundVariant>;
export declare const renderBackgroundProvider: (background: BackgroundVariant | undefined, element: ReactElement | null) => JSX.Element | null;
