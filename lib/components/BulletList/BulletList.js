...
var BulletListContext = /*#__PURE__*/createContext(false);
var validTones = ['neutral', 'secondary'];
...
export var BulletList = function BulletList(_ref) {
  ...
  return /*#__PURE__*/_jsx(BulletListContext.Provider, {
    value: true
  }, void 0, /*#__PURE__*/_jsx(List, {
    space: space,
    size: size,
    tone: tone
  }, void 0, children));
...
export var Bullet = function Bullet(_ref2) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    if (!useContext(BulletListContext)) {
      // eslint-disable-next-line no-console
      console.warn(dedent(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n        The \"BulletList\" and \"Bullet\" components have been deprecated and will be removed in a future version. Use \"List\" instead.\n        %c\n        - <BulletList>\n        -   <Bullet>...</Bullet>\n        -   <Bullet>...</Bullet>\n        -   <Bullet>...</Bullet>\n        - </BulletList>\n        %c\n        + <List>\n        +   <Text>...</Text>\n        +   <Text>...</Text>\n        +   <Text>...</Text>\n        + </List>\n      "]))), 'color: red', 'color: green');
    }
  }
