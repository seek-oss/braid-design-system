...
import { BraidProvider, DropdownMenu, DropdownMenuItem } from '..';
...
function renderDropdownMenu() {
  ...
  const { getAllByRole } = render(
    <BraidProvider theme={wireframe}>
      <DropdownMenu label="Options" onOpen={openHandler} onClose={closeHandler}>
        <DropdownMenuItem onClick={() => menuItemHandler('first')}>
          First
        </DropdownMenuItem>
        <DropdownMenuItem onClick={() => menuItemHandler('second')}>
          Second
        </DropdownMenuItem>
        <DropdownMenuItem onClick={() => menuItemHandler('third')}>
          Third
        </DropdownMenuItem>
      </DropdownMenu>
    </BraidProvider>,
...
describe('DropdownMenu', () => {
  describe('Mouse interactions', () => {
    ...
    it('should open menu when clicked', () => {
      const { getAllByRole, openHandler, closeHandler } = renderDropdownMenu();
    ...
    it('should toggle the menu when clicked again', () => {
      const { getAllByRole, closeHandler } = renderDropdownMenu();
    ...
    it('should set the focused menu item on mouse over', () => {
      const { getAllByRole } = renderDropdownMenu();
