...
interface InternalModalProps extends ModalPanelProps {
...
interface ModalPanelHeaderProps
  extends Pick<ModalPanelProps, 'headingLevel' | 'description'> {
  title: string;
  descriptionId: string;
  center?: boolean;
}
const ModalPanelHeader = forwardRef<HTMLElement, ModalPanelHeaderProps>(
