...
var modalPadding = ['gutter', 'large'];
var ModalContentHeader = /*#__PURE__*/forwardRef(function (_ref, ref) {
...
export var ModalContent = function ModalContent(_ref2) {
  var id = _ref2.id,
      ...
      data = _ref2.data;
  var defaultModalRef = useRef(null);
  var modalRef = modalRefProp || defaultModalRef;
  var defaultHeadingRef = useRef(null);
  var headingRef = headingRefProp || defaultHeadingRef;
  var descriptionId = "".concat(id, "_desc");
