...
export var Field = function Field(_ref) {
  ...
  var fieldBackground = disabled ? 'inputDisabled' : 'input';
  var showFieldBorder = useBackgroundLightness() === 'light' && (tone !== 'critical' || disabled);
  var hasValue = typeof value === 'string' ? value.length > 0 : value != null;

  var overlays = /*#__PURE__*/_jsx(Fragment, {}, void 0, /*#__PURE__*/_jsx(FieldOverlay, {
