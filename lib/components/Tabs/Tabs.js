...
import React, { Children, useContext, useEffect, useRef, useState, useCallback } from 'react';
...
export var Tabs = function Tabs(props) {
  ...
  var children = props.children,
      ...
      reserveHitArea = _props$reserveHitArea === void 0 ? false : _props$reserveHitArea,
  ...
  var tabItems = [];
  var tabs = Children.map(flattenChildren(children), function (tab, index) {
    var _tab$props$item;

    assert(_typeof(tab) === 'object' && tab.type === Tab, 'Only Tab elements can be direct children of a Tabs');
    tabItems.push((_tab$props$item = tab.props.item) !== null && _tab$props$item !== void 0 ? _tab$props$item : index);
  ...
  var updateMask = useCallback(function () {
    if (!tabsRef.current) {
      return;
    }
  ...
  return /*#__PURE__*/_jsx(Box, {}, void 0, /*#__PURE__*/_jsx(Box, {
    ...
    ref: tabsRef,
    className: [styles.scroll, styles.nowrap, showMask ? styles.mask : null],
    display: "flex",
    onScroll: updateMask,
    flexWrap: "nowrap"
  }, /*#__PURE__*/_jsx(Box, {
    ...
    paddingX: gutter,
    flexWrap: "nowrap"
  }, void 0, /*#__PURE__*/React.createElement(Box, _extends({}, a11y.tabListProps({
    label: label
  }), {
    display: "flex"
  }, data ? buildDataAttributes(data) : undefined, {
    flexWrap: "nowrap"
  }), tabs)), divider === 'full' ? /*#__PURE__*/_jsx(Box, {
    position: "absolute",
    bottom: 0,
    left: 0,
    right: 0,
