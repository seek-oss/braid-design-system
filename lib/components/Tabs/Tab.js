...
import { TAB_BUTTON_LEFT, TAB_BUTTON_RIGHT, TAB_BUTTON_HOME, TAB_BUTTON_END, TAB_BUTTON_ENTER, TAB_BUTTON_SPACE, TAB_BUTTON_TAB, TAB_LIST_FOCUSED, TAB_BUTTON_CLICK } from './Tabs.actions';
...
export var Tab = function Tab(_ref) {
  ...
  var tabListContext = useContext(TabListContext);
  ...
  assert(!badge || badge.props.bleedY === undefined, "Badge elements cannot set the 'bleedY' prop when passed to a Tab component");
  ...
  var focusedTabIndex = tabsContext.focusedTabIndex,
  ...
  var tabListItemIndex = tabListContext.tabListItemIndex,
      scrollContainer = tabListContext.scrollContainer,
      divider = tabListContext.divider;
  var isSelected = selectedIndex > -1 ? selectedIndex === tabListItemIndex : selectedItem === item;
  var isFocused = focusedTabIndex === tabListItemIndex;
  var paddingX = 'small';
  ...
  useEffect(function () {
    ...
    if (isSelected || isFocused) {
      if (breakpoint === 'mobile') {
        smoothScroll(tabRef.current, _objectSpread({
        ...
        smoothScrollIntoView(tabRef.current, _objectSpread({
          scrollContainer: scrollContainer,
          direction: 'horizontal',
  ...
  var onKeyDown = function onKeyDown(event) {
    ...
    var isArrowPress = targetKey.indexOf('Arrow') === 0; // Prevent enter or space press from triggering the click handler

    var isActionKeyPress = targetKey === 'Enter' || targetKey === ' ';
  ...
  return /*#__PURE__*/React.createElement(Box, _extends({
  ...
  }, data ? buildDataAttributes(data) : undefined), /*#__PURE__*/React.createElement(Text, _extends({}, a11y.tabLabelProps({
    tabIndex: tabListItemIndex
  }), {
    size: tabTextSize,
    weight: "medium",
    ...
    paddingLeft: "xsmall"
  }, void 0, /*#__PURE__*/cloneElement(badge, {
    bleedY: true
    ...
    overflow: "hidden",
    pointerEvents: "none"
  }, void 0, divider === 'minimal' ? /*#__PURE__*/_jsx(Box, {
    position: "absolute",
    zIndex: 1,
    left: 0,
    right: 0,
    ...
    bottom: 0,
    opacity: 0,
    className: [styles.tabUnderlineHover, styles.tabUnderline, tabListItemIndex > 0 ? styles.hairlineMarginLeft : null]
  }), /*#__PURE__*/_jsx(Box, {
    ...
    right: 0,
    bottom: 0,
    className: [styles.tabUnderline, !isSelected ? styles.tabUnderlineAnimation : undefined, tabListItemIndex > 0 ? styles.hairlineMarginLeft : null]
