...
var _excluded = ["children", "value", "onChange", "onBlur", "onFocus", "placeholder", "disabled"],
...
export var Dropdown = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return /*#__PURE__*/React.createElement(Field, _extends({}, restProps, {
    ...
    return /*#__PURE__*/_jsx(Fragment, {}, void 0, icon, /*#__PURE__*/React.createElement(Box, _extends({
      component: "select",
      value: value,
      ...
      ref: ref
    }), !value || placeholder ? _option || (_option = /*#__PURE__*/_jsx("option", {
      value: "",
      disabled: true
    }, void 0, placeholder)) : null, children), overlays, /*#__PURE__*/_jsx(Box, {
      position: "absolute",
      display: "flex",
      alignItems: "center",
