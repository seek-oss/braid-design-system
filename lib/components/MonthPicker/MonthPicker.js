...
var _excluded = ["id", "value", "label", "onChange", "onBlur", "onFocus", "tone", "disabled", "minYear", "maxYear", "ascendingYears", "monthLabel", "yearLabel", "monthNames"],
...
var getMonths = function getMonths(monthNames) {
...
var getYears = function getYears(min, max, ascending) {
  return _toConsumableArray(new Array(max - min + 1)).map(function (_v, i) {
    var yearStr = String(ascending ? i + min : max - i);
    return /*#__PURE__*/_jsx("option", {
      value: yearStr
    }, yearStr, yearStr);
  });
...
var renderNativeInput = isMobile({
  tablet: true
});

var customValueToString = function customValueToString(_ref) {
  var month = _ref.month,
      year = _ref.year;
  return month && year ? "".concat(year, "-").concat(month < 10 ? '0' : '').concat(month) : undefined;
};

var stringToCustomValue = function stringToCustomValue(value) {
...
var makeChangeHandler = function makeChangeHandler(onChange, value, fieldType) {
...
var MonthPicker = function MonthPicker(_ref2) {
  var _HiddenVisually, _HiddenVisually2;
  ...
  var id = _ref2.id,
      ...
      ascendingYears = _ref2$ascendingYears === void 0 ? false : _ref2$ascendingYears,
      ...
      monthNames = _ref2$monthNames === void 0 ? defaultMonthNames : _ref2$monthNames,
  ...
  var blurHandler = onBlur ? function (event) {
    var fireIfExternal = function fireIfExternal(element) {
  ...
  var focusHandler = onFocus ? function (event) {
    if (event.relatedTarget !== monthRef.current && event.relatedTarget !== yearRef.current) {
      onFocus();
    }
  } : undefined;
  var nativeField = /*#__PURE__*/React.createElement(Field, _extends({
    id: id,
    tone: tone,
    disabled: disabled,
    label: label,
  ...
  var customFieldGroup = /*#__PURE__*/React.createElement(FieldGroup, _extends({
    id: id,
    label: label,
    tone: tone,
    disabled: disabled
  }, restProps), function (fieldGroupProps) {
    return /*#__PURE__*/_jsx(Columns, {
      space: "medium"
    }, void 0, /*#__PURE__*/_jsx(Column, {}, void 0, _HiddenVisually || (_HiddenVisually = /*#__PURE__*/_jsx(HiddenVisually, {}, void 0, /*#__PURE__*/_jsx("label", {
      htmlFor: monthId
    }, void 0, monthLabel))), /*#__PURE__*/React.createElement(Dropdown, _extends({
      id: monthId,
      ...
      ref: monthRef
    }), getMonths(monthNames))), /*#__PURE__*/_jsx(Column, {}, void 0, _HiddenVisually2 || (_HiddenVisually2 = /*#__PURE__*/_jsx(HiddenVisually, {}, void 0, /*#__PURE__*/_jsx("label", {
      htmlFor: yearId
    }, void 0, yearLabel))), /*#__PURE__*/React.createElement(Dropdown, _extends({
      id: yearId,
