...
export declare function useMenuItem<MenuItemElement extends HTMLElement>({ displayName, formElement, tone, onClick, data, }: UseMenuItemProps): {
...
declare function MenuItemChildren({ tone, children }: MenuItemChildrenProps): JSX.Element;
export {};
