...
var _excluded = ["size", "tone", "alignY", "data"];
...
export var iconContainerSize = function iconContainerSize() {
  var size = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'standard';
  return clsx(styles.blockWidths[size], lineHeightContainer[size]);
};
var detaultVerticalCorrection = {
  uppercase: 'none',
  lowercase: 'none'
};
export default (function (_ref2) {
  ...
  var inheritedTone = textContext && textContext.tone ? textContext.tone : 'neutral';
  var resolvedTone = useTextTone({
    tone: tone || inheritedTone
  });
  var isInline = textContext || headingContext;
  var a11yProps = titleProps.title ? _objectSpread(_objectSpread({}, titleProps), {}, {
    role: 'img'
  }) : {
    'aria-hidden': true
  };
