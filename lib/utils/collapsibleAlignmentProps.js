...
export function resolveCollapsibleAlignmentProps(_ref) {
  ...
  var rowReverseTablet = collapseMobile && reverse;
  var rowReverseDesktop = (collapseMobile || collapseTablet) && reverse;
  var normalizedAlign = normalizeResponsiveValue(alignToFlexAlign(align) || 'flexStart');
  var _normalizedAlign$mobi = normalizedAlign.mobile,
