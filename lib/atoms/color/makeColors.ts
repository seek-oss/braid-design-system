...
export default ({
  ...
  '.color_criticalContrast': { color: getAccessibleVariant(critical) },
  '.color_positive': { color: positive },
  '.color_positiveContrast': { color: getAccessibleVariant(positive) },
  '.color_secondary': { color: secondary },
  '.color_info': { color: info },
  '.color_infoContrast': { color: getAccessibleVariant(info) },
