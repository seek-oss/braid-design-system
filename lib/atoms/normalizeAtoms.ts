...
export default (
  ...
  color: {
    ...
    criticalDark: atoms.color_critical_dark,
    ...
    positiveDark: atoms.color_positive_dark,
    secondary: atoms.color_secondary,
    info: atoms.color_info,
    infoDark: atoms.color_info_dark,
  ...
  fill: {
    ...
    criticalDark: atoms.fill_criticalDark,
    ...
    infoDark: atoms.fill_infoDark,
    positive: atoms.fill_positive,
    positiveDark: atoms.fill_positiveDark,
