...
const tokens: BraidTokens = {
  ...
  color: {
    ...
    background: {
      ...
      brandAccentLighter: palette.grey['200'],
      brandAccentLighterActive: darken(0.025, palette.grey['200']),
      brandAccentLighterHover: darken(0.05, palette.grey['200']),
      card: white,
      ...
      criticalLighter: palette.red['100'],
      criticalLighterActive: darken(0.05, palette.red['100']),
      criticalLighterHover: darken(0.025, palette.red['100']),
      formAccent,
      formAccentActive: palette.indigo['700'],
      formAccentDisabled: palette.grey['200'],
      formAccentHover: palette.indigo['600'],
      formAccentLighter: palette.indigo['100'],
      formAccentLighterActive: darken(0.05, palette.indigo['100']),
      formAccentLighterHover: darken(0.025, palette.indigo['100']),
      info: palette.blue['600'],
      ...
      promote: palette.purple['600'],
      promoteAccent: palette.purple['500'],
