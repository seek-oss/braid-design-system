...
const tokens: BraidTokens = {
  ...
  buttonBackgroundSoft: {
    ...
    critical: palette.red['100'],
    criticalActive: darken(0.05, palette.red['100']),
    criticalHover: darken(0.025, palette.red['100']),
    formAccent: palette.indigo['100'],
