  ...
  const tokens: BraidTokens = {
    ...
    color: {
      ...
      background: {
        ...
        brandAccentActive,
        brandAccentHover,
        brandAccentLighter: brandAccentSoft,
        brandAccentLighterActive: brandAccentSoftActive,
        brandAccentLighterHover: brandAccentSoftHover,
        card: white,
        caution: palette.yellow['500'],
        cautionAccent: palette.yellow['500'],
        cautionLight: palette.yellow['100'],
        critical,
        criticalAccent: palette.red['500'],
        criticalActive: darken(0.05, critical),
        criticalHover: saturate(0.15, lighten(0.05, critical)),
        criticalLight: palette.red['100'],
        criticalLighter: palette.red['50'],
        criticalLighterActive: darken(0.05, palette.red['50']),
        criticalLighterHover: darken(0.025, palette.red['50']),
        formAccent,
        ...
        formAccentLighter: palette.indigo['50'],
        formAccentLighterActive: darken(0.05, palette.indigo['50']),
        formAccentLighterHover: darken(0.025, palette.indigo['50']),
        info: palette.blue['600'],
        infoAccent: palette.blue['500'],
        ...
        positiveAccent: palette.mint['500'],
        positiveLight: palette.mint['100'],
        promote: palette.plum['600'],
        promoteAccent: palette.plum['500'],
