...
const tokens: BraidTokens = {
  ...
  color: {
    ...
    background: {
      ...
      brandAccentLighter: tint(0.925, brandAccent),
      brandAccentLighterActive: tint(0.85, brandAccent),
      brandAccentLighterHover: tint(0.9, brandAccent),
      card: white,
      caution,
      cautionAccent: caution,
      cautionLight: getLightVariant(caution),
      critical,
      criticalAccent: critical,
      criticalActive: getActiveColor(critical),
      criticalHover: getHoverColor(critical),
      criticalLight: tint(0.925, critical),
      criticalLighter: tint(0.925, critical),
      criticalLighterActive: tint(0.85, critical),
      criticalLighterHover: tint(0.9, critical),
      formAccent,
      formAccentActive: getActiveColor(formAccent),
      formAccentDisabled: '#ccc',
      formAccentHover: getHoverColor(formAccent),
      formAccentLighter: tint(0.925, formAccent),
      formAccentLighterActive: tint(0.85, formAccent),
      formAccentLighterHover: tint(0.9, formAccent),
      info,
      infoAccent: info,
      ...
      positive,
      positiveAccent: positive,
      positiveLight: getLightVariant(positive),
      promote,
      promoteAccent: promote,
