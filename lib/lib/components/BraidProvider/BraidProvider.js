...
export var BraidProvider = function BraidProvider(_ref) {
  ...
  var alreadyInBraidProvider = Boolean(useContext(BraidThemeContext));
  var inTestProvider = useContext(BraidTestProviderContext);
  var linkComponentFromContext = useContext(LinkComponentContext);
  useHideFocusRings(!(alreadyInBraidProvider || inTestProvider));
  assert((typeof navigator === "undefined" ? "undefined" : _typeof(navigator)) !== 'object' || navigator.userAgent.indexOf('jsdom') === -1 || inTestProvider, "Rendering 'BraidProvider' in Jest is not supported as it expects a browser environment. Please switch to 'BraidTestProvider'. See the docs for more info: https://seek-oss.github.io/braid-design-system/components/BraidTestProvider");
  return /*#__PURE__*/_jsx(BraidThemeContext.Provider, {
    value: theme
  }, void 0, /*#__PURE__*/_jsx(TreatProvider, {
    theme: theme.treatTheme
  }, void 0, styleBody ? /*#__PURE__*/_jsx("style", {
    type: "text/css"
  }, void 0, "body{margin:0;padding:0;background:".concat(theme.background, "}")) : null, /*#__PURE__*/_jsx("div", {
    className: theme.vanillaTheme
  }, void 0, /*#__PURE__*/_jsx(LinkComponentContext.Provider, {
    value: linkComponent || linkComponentFromContext
  }, void 0, alreadyInBraidProvider || inTestProvider ? children : /*#__PURE__*/_jsx(BreakpointProvider, {}, void 0, children)))));
};
