...
var _TextLink, _IconSearch;

import React from 'react';
import { IconSearch, TextField, TextLink, Text, Strong, List, IconHelp, Stack } from '../';
...
var docs = {
  ...
  Example: function Example(_ref) {
    ...
    return source( /*#__PURE__*/_jsx(TextField, {
      label: "Label",
      id: id,
  ...
  additional: [{
    ...
    Example: function Example(_ref3) {
      ...
      return source( /*#__PURE__*/_jsx(Stack, {
        space: "large"
      }, void 0, /*#__PURE__*/_jsx(TextField, {
        label: "Label",
        id: "".concat(id, "_1"),
        onChange: setState('textfield'),
        value: getState('textfield'),
    ...
    description: /*#__PURE__*/_jsx(Text, {}, void 0, "A ", /*#__PURE__*/_jsx(TextLink, {
      href: "/components/IconClear"
    }, void 0, "clear icon"), " button will appear in the field when the user has entered text. You must pass a function to the ", /*#__PURE__*/_jsx(Strong, {}, void 0, "onClear"), " prop, which will be called when the button is clicked."),
    Example: function Example(_ref7) {
      var id = _ref7.id,
          getState = _ref7.getState,
          setState = _ref7.setState,
          setDefaultState = _ref7.setDefaultState;
      return source( /*#__PURE__*/React.createElement(React.Fragment, null, setDefaultState('textfield', 'User entered text'), /*#__PURE__*/_jsx(TextField, {
        label: "Label",
        id: id,
        onChange: setState('textfield'),
        value: getState('textfield'),
    ...
    description: /*#__PURE__*/_jsx(Text, {}, void 0, "The ", /*#__PURE__*/_jsx(Strong, {}, void 0, "prefix"), " prop allows you to prepend read-only content on the left-hand side of the field. This is typically used for currency symbols, country codes, etc."),
