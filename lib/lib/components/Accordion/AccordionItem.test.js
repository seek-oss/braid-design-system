...
describe('AccordionItem', function () {
  it('should provide internal state by default', function () {
    var _render = render(_BraidTestProvider || (_BraidTestProvider = /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(AccordionItem, {
      id: "content",
      label: "Label"
    }, void 0, "Content")))),
  ...
  it('should support listening to toggle events while uncontrolled', function () {
    ...
    var _render2 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(AccordionItem, {
      id: "content",
      label: "Label",
  ...
  it('should support controlled state', function () {
    var TestCase = function TestCase() {
      ...
      return /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(AccordionItem, {
        id: "content",
        label: "Label",
        expanded: expanded,
