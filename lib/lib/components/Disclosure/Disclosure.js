...
var _excluded = ["id", "expandLabel", "collapseLabel", "space", "children", "data"];
...
export var Disclosure = function Disclosure(_ref) {
  var id = _ref.id,
      ...
      collapseLabel = _ref$collapseLabel === void 0 ? expandLabel : _ref$collapseLabel,
  ...
  return /*#__PURE__*/React.createElement(Box, data ? buildDataAttributes(data) : undefined, /*#__PURE__*/_jsx(Box, {
    userSelect: "none"
  }, void 0, /*#__PURE__*/_jsx(Text, {}, void 0, /*#__PURE__*/React.createElement(TextLinkButton, _extends({
    hitArea: "large"
  }, buttonProps), expanded ? collapseLabel : expandLabel, /*#__PURE__*/_jsx(Box, {
    component: "span",
    paddingLeft: "xxsmall"
