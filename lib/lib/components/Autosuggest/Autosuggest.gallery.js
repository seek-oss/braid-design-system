...
export var galleryItems = [{
  ...
  Example: function Example(_ref) {
    ...
    return source( /*#__PURE__*/React.createElement(React.Fragment, null, setDefaultState('value', {
      text: ''
    }), setDefaultState('showRecent', true), /*#__PURE__*/_jsx(Autosuggest, {
      label: "I like to eat",
      id: id,
      ...
      suggestions: filterSuggestions([].concat(_toConsumableArray(getState('showRecent') && getState('value').text === '' ? [{
        text: 'Apples',
        onClear: function onClear() {
          return setState('showRecent', false);
        }
      }] : []), _toConsumableArray(makeSuggestions([].concat(_toConsumableArray(getState('value').text !== '' ? ['Apples'] : []), ['Bananas', 'Broccoli', 'Carrots'])))))
    })));
  }
}, {
  ...
  Example: function Example(_ref3) {
    ...
    return source( /*#__PURE__*/React.createElement(React.Fragment, null, setDefaultState('value', {
      ...
      }] : []), _toConsumableArray(makeSuggestions([].concat(_toConsumableArray(getState('value').text !== '' ? [{
        text: 'Apples',
        description: 'Juicy and delicious'
      }] : []), [{
        text: 'Bananas',
