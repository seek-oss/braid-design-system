...
function renderAutosuggest(_ref) {
  ...
  var _setSuggestions = function setSuggestions() {
    /* */
  };
  ...
  var TestCase = function TestCase() {
    ...
    return /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Autosuggest, {
      id: "fruit",
      label: "Fruit",
...
describe('Autosuggest', function () {
  it('should toggle suggestion visibility on focus and blur', function () {
    var _renderAutosuggest = renderAutosuggest({
      value: {
        text: ''
      },
      suggestions: [{
  ...
  it('should show text highlights', function () {
    var _renderAutosuggest2 = renderAutosuggest({
      value: {
        text: ''
      },
      suggestions: [{
  ...
  it('should support suggestions as a function', function () {
    ...
    userEvent.click(input);
    var highlight = queryByText('Apples');
    expect(highlight && highlight.tagName).toBe('STRONG');
  });
  it('should select suggestions on click', function () {
    var _renderAutosuggest4 = renderAutosuggest({
      value: {
        text: ''
      },
      suggestions: [{
    ...
    var suggestion = queryByLabelText('Apples');
  ...
  it('should support custom suggestion labels', function () {
    var _renderAutosuggest5 = renderAutosuggest({
      value: {
        text: ''
      },
      suggestions: [{
    ...
    expect(getInputValue()).toBe('');
    expect(changeHandler).not.toHaveBeenCalled();
    var suggestion = queryByLabelText('CUSTOM LABEL');
  ...
  it('should keep the menu open when a selection is made if "hideSuggestionsOnSelection" is false', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
    var TestCase, _render2, getByRole, queryByLabelText, input, getInputValue, suggestion;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _render2 = render( /*#__PURE__*/_jsx(TestCase, {})), getByRole = _render2.getByRole, queryByLabelText = _render2.queryByLabelText;
  ...
  it('should pass through focus and blur events', function () {
    var focusHandler = jest.fn();
    var blurHandler = jest.fn();

    var _renderAutosuggest6 = renderAutosuggest({
      value: {
        text: ''
      },
      suggestions: [{
  ...
  it("should call 'onClear' handler when clearing suggestions", function () {
    var clearHandler = jest.fn();

    var _renderAutosuggest7 = renderAutosuggest({
      value: {
        text: ''
      },
      suggestions: [{
    ...
    var clearApples = queryByLabelText('Clear "Apples"');
    ...
    var clearBananas = queryByLabelText('Clear "Bananas"');
  ...
  it('should forward refs', function () {
    var TestCase = function TestCase() {
      ...
      return /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/React.createElement(Autosuggest, {
        id: "id",
        label: "Label",
        value: {
          text: ''
    ...
    var _render3 = render( /*#__PURE__*/_jsx(TestCase, {})),
  ...
  describe('ARIA labels', function () {
    it('should associate the field label with the input', function () {
      var _renderAutosuggest8 = renderAutosuggest({
        value: {
          text: ''
        },
        suggestions: [{
      ...
      var result = queryByLabelText('Fruit');
      expect(result).toBe(input);
    });
    it('should support standard suggestions', function () {
      var _renderAutosuggest9 = renderAutosuggest({
        value: {
          text: ''
        },
        suggestions: [{
    ...
    it('should support grouped suggestions', function () {
      var _renderAutosuggest10 = renderAutosuggest({
        value: {
          text: ''
        },
        suggestions: [{
    ...
    it('should support suggestions with descriptions', function () {
      var _renderAutosuggest11 = renderAutosuggest({
        value: {
          text: ''
        },
        suggestions: [{
      ...
      userEvent.click(input);
      expect(queryByLabelText('Apples - Juicy and delicious')).toBeInTheDocument();
    });
    it('should support grouped suggestions with descriptions', function () {
      var _renderAutosuggest12 = renderAutosuggest({
        value: {
          text: ''
        },
        suggestions: [{
      ...
      userEvent.click(input);
      expect(queryByLabelText('Apples - Juicy and delicious (Fruit)')).toBeInTheDocument();
    });
  });
  describe('keyboard access', function () {
    it("shouldn't select anything and close the list on enter if the user hasn't navigated the list", function () {
      var _renderAutosuggest13 = renderAutosuggest({
        value: {
          text: ''
        },
        suggestions: [{
    ...
    it('should select a suggestion on enter after navigating the list', function () {
      var _renderAutosuggest14 = renderAutosuggest({
        value: {
          text: ''
        },
        suggestions: [{
    ...
    it('should first clear the suggestion preview and then reset the input when pressing escape', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
      var _renderAutosuggest15, input, changeHandler, queryByLabelText, getInputValue;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              }), input = _renderAutosuggest15.input, changeHandler = _renderAutosuggest15.changeHandler, queryByLabelText = _renderAutosuggest15.queryByLabelText, getInputValue = _renderAutosuggest15.getInputValue;
              userEvent.click(input);
              _context2.next = 4;
    ...
    it('should select a suggestion on enter after navigating a single suggestion', function () {
      var _renderAutosuggest16 = renderAutosuggest({
        value: {
          text: ''
        },
        suggestions: [{
    ...
    it('should keep the menu open on selection if "hideSuggestionsOnSelection" is false', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3() {
      var TestCase, _render4, getByRole, queryByLabelText, input, getInputValue;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _render4 = render( /*#__PURE__*/_jsx(TestCase, {})), getByRole = _render4.getByRole, queryByLabelText = _render4.queryByLabelText;
              input = getByRole('combobox');
    ...
    it('should select a grouped suggestion on enter after navigating the list', function () {
      var _renderAutosuggest17 = renderAutosuggest({
        value: {
          text: ''
        },
        suggestions: [{
  ...
  it('should select a suggestion on enter after navigating to a single grouped suggestion', function () {
    var _renderAutosuggest18 = renderAutosuggest({
      value: {
        text: ''
      },
      suggestions: [{
  ...
  it('should support messages', function () {
    ...
    var _render5 = render( /*#__PURE__*/_jsx(TestCase, {})),
  ...
  describe('automaticSelection', function () {
    it("shouldn't select anything on enter if the user hasn't typed anything", function () {
      var _renderAutosuggest19 = renderAutosuggest({
    ...
    it("shouldn't select anything on blur if the user hasn't typed anything", function () {
      var _renderAutosuggest20 = renderAutosuggest({
        automaticSelection: true,
        value: {
          text: ''
        },
    ...
    it("shouldn't select anything on blur if the field is populated and the user hasn't typed anything", function () {
      var _renderAutosuggest21 = renderAutosuggest({
        automaticSelection: true,
        value: {
    ...
    it("shouldn't select anything on blur if the suggestions are hidden", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4() {
      var _renderAutosuggest22, input, changeHandler, getInputValue, queryByLabelText;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              }), input = _renderAutosuggest22.input, changeHandler = _renderAutosuggest22.changeHandler, getInputValue = _renderAutosuggest22.getInputValue, queryByLabelText = _renderAutosuggest22.queryByLabelText;
              expect(getInputValue()).toBe('');
              userEvent.click(input);
    ...
    it("shouldn't select anything on blur if the user clears the field", function () {
      var _renderAutosuggest23 = renderAutosuggest({
        automaticSelection: true,
        value: {
          text: 'abc'
        },
    ...
    it('should select the first suggestion on enter after typing something', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5() {
      var _renderAutosuggest24, input, changeHandler, getInputValue;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              }), input = _renderAutosuggest24.input, changeHandler = _renderAutosuggest24.changeHandler, getInputValue = _renderAutosuggest24.getInputValue;
              userEvent.click(input);
              expect(getInputValue()).toBe('');
              _context5.next = 5;
    ...
    it('should select the first suggestion on enter after typing something when the suggestions are async', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6() {
      var _renderAutosuggest25, input, changeHandler, getInputValue, setSuggestions, queryByLabelText;
          ...
          switch (_context6.prev = _context6.next) {
            case 0:
              _renderAutosuggest25 = renderAutosuggest({
                ...
                suggestions: []
              }), input = _renderAutosuggest25.input, changeHandler = _renderAutosuggest25.changeHandler, getInputValue = _renderAutosuggest25.getInputValue, setSuggestions = _renderAutosuggest25.setSuggestions, queryByLabelText = _renderAutosuggest25.queryByLabelText;
              userEvent.click(input);
              expect(getInputValue()).toBe('');
              _context6.next = 5;
              return userEvent.type(input, 'a');
    ...
    it('should allow you to navigate a suggestions list with a single item', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7() {
      var _renderAutosuggest26, input, changeHandler, getInputValue;
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              }), input = _renderAutosuggest26.input, changeHandler = _renderAutosuggest26.changeHandler, getInputValue = _renderAutosuggest26.getInputValue;
              userEvent.click(input);
              expect(getInputValue()).toBe('');
              _context7.next = 5;
              return userEvent.type(input, 'a');
    ...
    it('should select the first suggestion on blur after typing something', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8() {
      var _renderAutosuggest27, input, changeHandler, getInputValue;
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              }), input = _renderAutosuggest27.input, changeHandler = _renderAutosuggest27.changeHandler, getInputValue = _renderAutosuggest27.getInputValue;
              userEvent.click(input);
              expect(getInputValue()).toBe('');
              _context8.next = 5;
              return userEvent.type(input, 'a');
    ...
    it('should initially highlight the first suggestion when navigating the list', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9() {
      var _renderAutosuggest28, input, changeHandler, getInputValue;
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              }), input = _renderAutosuggest28.input, changeHandler = _renderAutosuggest28.changeHandler, getInputValue = _renderAutosuggest28.getInputValue;
              userEvent.click(input);
              expect(getInputValue()).toBe('');
              _context9.next = 5;
              return userEvent.type(input, 'a');
    ...
    it('should select the highlighted suggestion on blur after navigating the list', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee10() {
      var _renderAutosuggest29, input, changeHandler, getInputValue;
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              }), input = _renderAutosuggest29.input, changeHandler = _renderAutosuggest29.changeHandler, getInputValue = _renderAutosuggest29.getInputValue;
              userEvent.click(input);
              _context10.next = 4;
              return userEvent.type(input, 'a');
