...
var _BraidTestProvider, _ButtonLink, _ButtonLink2, _BraidTestProvider2;

import '@testing-library/jest-dom/extend-expect';
import React from 'react';
import { render } from '@testing-library/react';
import { htmlToText } from '../../utils/htmlToText';
import { BraidTestProvider, makeLinkComponent, ButtonLink } from '..';
describe('ButtonLink', function () {
  it('should render a native link by default', function () {
    var _render = render(_BraidTestProvider || (_BraidTestProvider = /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(ButtonLink, {
      href: "/foo/bar",
      "data-attribute": "true"
    }, void 0, "Link content")))),
  ...
  it('should render a custom link component if provided', function () {
    ...
    }, void 0, _ButtonLink || (_ButtonLink = /*#__PURE__*/_jsx(ButtonLink, {
      href: "/foo/bar",
      "data-attribute": "true"
    }, void 0, "Link content")))),
  ...
  it('should render a legacy link component if provided', function () {
    ...
    var _render3 = render( /*#__PURE__*/_jsx(BraidTestProvider, {
      linkComponent: CustomLink
    }, void 0, _ButtonLink2 || (_ButtonLink2 = /*#__PURE__*/_jsx(ButtonLink, {
      href: "/foo/bar",
      "data-attribute": "true"
    }, void 0, "Link content")))),
  ...
  it("should inherit custom link components from the root provider if the nearest provider doesn't have one", function () {
    ...
    var _render4 = render( /*#__PURE__*/_jsx(BraidTestProvider, {
      linkComponent: CustomLink
    }, void 0, _BraidTestProvider2 || (_BraidTestProvider2 = /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(ButtonLink, {
      href: "/foo/bar",
      "data-attribute": "true"
    }, void 0, "Link content"))))),
  ...
  it('should not support custom styles', function () {
    var _render5 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(ButtonLink, {
      href: "/foo/bar",
