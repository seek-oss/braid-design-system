...
var _Alert, _Alert2, _Alert3, _Alert4, _Alert5, _Text, _Alert6;
...
export var galleryItems = [{
  ...
  label: 'Info',
  Example: function Example() {
    return source(_Alert2 || (_Alert2 = /*#__PURE__*/_jsx(Alert, {
      tone: "info"
  ...
  label: 'Positive',
  Example: function Example() {
    return source(_Alert3 || (_Alert3 = /*#__PURE__*/_jsx(Alert, {
      tone: "positive"
  ...
  label: 'Caution',
  Example: function Example() {
    return source(_Alert4 || (_Alert4 = /*#__PURE__*/_jsx(Alert, {
      tone: "caution"
    }, void 0, /*#__PURE__*/_jsx(Text, {}, void 0, "This is a cautionary message."))));
  }
}, {
  label: 'Critical',
  Example: function Example() {
    return source(_Alert5 || (_Alert5 = /*#__PURE__*/_jsx(Alert, {
      tone: "critical"
  ...
  label: 'Dismissible',
  Example: function Example() {
    return source( /*#__PURE__*/_jsx(Alert, {
      tone: "info",
  ...
  Example: function Example() {
    return source(_Alert6 || (_Alert6 = /*#__PURE__*/_jsx(Alert, {
      tone: "info"
