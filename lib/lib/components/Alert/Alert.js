...
import { IconInfo, IconCritical, IconPositive, IconPromote, IconCaution } from '../icons';
...
export var Alert = function Alert(_ref) {
  ...
  }, void 0, children)), onClose ? /*#__PURE__*/_jsx(Column, {
    width: "content"
  }, void 0, /*#__PURE__*/_jsx(ClearButton, {
    tone: "neutral",
    label: closeLabel,
    onClick: onClose
  })) : null)), parentBackground !== 'card' && /*#__PURE__*/_jsx(Overlay, {
    borderRadius: "standard",
    boxShadow: borderForTone[tone],
    visible: true,
    className: (_ref2 = {}, _defineProperty(_ref2, styles.toneBorder, tone !== 'caution'), _defineProperty(_ref2, styles.cautionBorder, tone === 'caution'), _ref2)
  }), /*#__PURE__*/_jsx(Box, {
    background: tone,
    paddingLeft: highlightBarSize,
    position: "absolute",
