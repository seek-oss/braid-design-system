...
import { FieldMessage, Alert, Text, Strong, List, TextLink, Stack, Box } from '../';
...
var docs = {
  ...
  accessibility: /*#__PURE__*/_jsx(Text, {}, void 0, "The ", /*#__PURE__*/_jsx(Strong, {}, void 0, "id"), " prop is required, but you should also ensure that the associated field has a matching ", /*#__PURE__*/_jsx(Strong, {}, void 0, "aria-describedby"), ' ', "prop."),
  alternatives: [],
  additional: [{
    label: 'See also',
    ...
    }, void 0, "FieldLabel"), ' ', "\u2014 For displaying labels above a custom field."))
  }]
};
export default docs;