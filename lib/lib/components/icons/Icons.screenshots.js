...
var _Icons, _Icons2, _Icons3, _Icons4, _Text, _Stack;
...
var iconNames = Object.keys(icons).map(function (icon) {
  return icon;
});
...
export var screenshots = {
  ...
  examples: [{
    ...
    Example: function Example() {
      var headings = Object.keys(headingSizes);
      return /*#__PURE__*/_jsx(Stack, {
        space: "large"
    ...
    Example: function Example() {
      var iconTones = ['neutral'].concat(_toConsumableArray(Object.keys(tones))).sort();
      return /*#__PURE__*/_jsx(Stack, {
        space: "large"
