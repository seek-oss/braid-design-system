...
var _Tabs, _TabPanel, _TabPanel2, _TabPanel3;
...
import { BraidTestProvider, Tabs, Tab, TabPanel, TabsProvider, TabPanels } from '..';
var ENTER = 13;
var SPACE = 32;
var END = 35;
var HOME = 36;
...
var TestPanel = function TestPanel(_ref) {
  ...
  return /*#__PURE__*/_jsx(Fragment, {}, void 0, /*#__PURE__*/_jsx("input", {
    type: "checkbox",
...
function renderTabs() {
  ...
  var TestCase = function TestCase(_ref3) {
    var value = _ref3.value;
    return (
      /*#__PURE__*/
      // Note: This test case also ensures that null/undefined
      // and fragments are handled correctly.
      _jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(TabsProvider, {
        id: "tabs",
        selectedItem: value,
        ...
        item: "first"
      }, void 0, "First"), null, undefined, /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/_jsx(Tab, {
        item: "second"
      }, void 0, "Second"), /*#__PURE__*/_jsx(Tab, {
        item: "third"
      }, void 0, "Third")))), _TabPanels || (_TabPanels = /*#__PURE__*/_jsx(TabPanels, {
        renderInactivePanels: renderInactivePanels
      }, void 0, _TabPanel || (_TabPanel = /*#__PURE__*/_jsx(TabPanel, {}, void 0, /*#__PURE__*/_jsx(TestPanel, {}, void 0, "panel-1"))), null, undefined, /*#__PURE__*/React.createElement(React.Fragment, null, _TabPanel2 || (_TabPanel2 = /*#__PURE__*/_jsx(TabPanel, {}, void 0, /*#__PURE__*/_jsx(TestPanel, {}, void 0, "panel-2"))), _TabPanel3 || (_TabPanel3 = /*#__PURE__*/_jsx(TabPanel, {}, void 0, /*#__PURE__*/_jsx(TestPanel, {}, void 0, "panel-3"))))))))
    );
  };
  ...
  return {
    ...
    updateSelectedItem: function updateSelectedItem(item) {
      rerender( /*#__PURE__*/_jsx(TestCase, {
        value: item
      }));
    },
...
describe('Tabs', function () {
  describe('Uncontrolled state', function () {
    it('should select the first tab by default', function () {
      var _renderTabs = renderTabs(),
          getAllByRole = _renderTabs.getAllByRole;

      var _getAllByRole = getAllByRole('tab'),
    ...
    it('should select first tab and show first panel when toggling back from another tab', function () {
      var _renderTabs3 = renderTabs(),
          getAllByRole = _renderTabs3.getAllByRole;

      var _getAllByRole5 = getAllByRole('tab'),
  ...
  describe('Aria', function () {
    ...
    it('should mark the selectedItem tab as selected and show the associated panel', function () {
      var _renderTabs9 = renderTabs({
        selectedItem: 'second'
      }),
          getAllByRole = _renderTabs9.getAllByRole;

      var _getAllByRole13 = getAllByRole('tab'),
    ...
    it('should focus selected tab and then the selected panel when tabbing through the component', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
      var _renderTabs10, getAllByRole, secondTab, visiblePanels;
    ...
    it('should navigate through horizontal tablist with horizontal arrows only', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
      var _renderTabs11, getAllByRole, _getAllByRole15, _getAllByRole16, firstTab, secondTab, thirdTab;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _getAllByRole15 = getAllByRole('tab'), _getAllByRole16 = _slicedToArray(_getAllByRole15, 3), firstTab = _getAllByRole16[0], secondTab = _getAllByRole16[1], thirdTab = _getAllByRole16[2]; // Focus selected tab
    ...
    it('should navigate to last tab with the end key', function () {
      var _renderTabs12 = renderTabs(),
          getAllByRole = _renderTabs12.getAllByRole;

      var _getAllByRole17 = getAllByRole('tab'),
    ...
    it('should navigate to first tab with the home key', function () {
      var _renderTabs13 = renderTabs({
        selectedItem: 'third'
      }),
          getAllByRole = _renderTabs13.getAllByRole;

      var _getAllByRole19 = getAllByRole('tab'),
    ...
    it('should select the focused tab with the space key', function () {
      var _renderTabs14 = renderTabs(),
          getAllByRole = _renderTabs14.getAllByRole;

      var _getAllByRole21 = getAllByRole('tab'),
    ...
    it('should select the focused tab with the enter key', function () {
      var _renderTabs15 = renderTabs(),
          getAllByRole = _renderTabs15.getAllByRole;

      var _getAllByRole23 = getAllByRole('tab'),
