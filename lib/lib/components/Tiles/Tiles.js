...
import { negativeMarginTop, negativeMarginLeft } from '../../atoms/negativeMargin/negativeMargin';
...
export var Tiles = function Tiles(_ref) {
  ...
  }, void 0, Children.map(flattenChildren(children), function (child, i) {
    return /*#__PURE__*/_jsx(Box, {
      minWidth: 0,
      className: resolveResponsiveProp(columns, styles.columnsMobile, styles.columnsTablet, styles.columnsDesktop)
    }, void 0, /*#__PURE__*/_jsx(Box, {
      height: "full" // This needs to be a separate element to support IE11.
      ,
      paddingTop: space,
      paddingLeft: space
    }, void 0, dividers && i > 0 ? /*#__PURE__*/_jsx(Box, {
      paddingBottom: space,
      ...
      weight: dividers
    })) : _Divider2 || (_Divider2 = /*#__PURE__*/_jsx(Divider, {}))) : null, child));
  })));
};
