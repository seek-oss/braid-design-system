...
export var screenshots = {
  ...
  examples: [{
    ...
    Example: function Example(_ref3) {
      ...
      var _useState3 = useState('qwerty'),
    ...
    Example: function Example(_ref4) {
      ...
      var _useState5 = useState('qwerty'),
    ...
    Example: function Example(_ref5) {
      ...
      var _useState7 = useState('qwerty'),
    ...
    Example: function Example(_ref6) {
      ...
      var _useState9 = useState('qwerty'),
    ...
    Example: function Example(_ref7) {
      ...
      var _useState11 = useState('qwerty'),
    ...
    Example: function Example(_ref8) {
      ...
      var _useState13 = useState('qwerty'),
    ...
    Example: function Example(_ref9) {
      ...
      var _useState15 = useState('qwerty'),
    ...
    Example: function Example(_ref10) {
      ...
      var _useState17 = useState('qwerty'),
