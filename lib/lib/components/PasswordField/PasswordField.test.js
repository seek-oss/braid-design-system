...
describe('PasswordField', function () {
  it('should render with password hidden', function () {
    ...
    var _render = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(PasswordField, {
      id: "password",
      label: "Password",
      value: "",
      onChange: onChange
  ...
  it('should show the password as plain text when visibility button clicked', function () {
    ...
    var _render2 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(PasswordField, {
      id: "password",
      label: "Password",
      value: "",
      onChange: onChange
    ...
    var input = getByLabelText('Password');
    var visibilityButton = getByRole('button');
  ...
  it('should call the onVisibilityToggle handler with the new visibility state when toggled', function () {
    var onChange = jest.fn();
    var onVisibilityToggle = jest.fn();

    var _render3 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(PasswordField, {
      id: "password",
      label: "Password",
      value: "",
      onChange: onChange,
  ...
  it('should not show the visibility toggle button when disabled', function () {
    ...
    var _render4 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(PasswordField, {
      id: "password",
      label: "Password",
      disabled: true,
      value: "",
    ...
    var visibilityButton = queryByRole('button');
    expect(visibilityButton).not.toBeInTheDocument();
  });
  it('associates field with label correctly', function () {
    var _render5 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(PasswordField, {
      id: "field",
      label: "My field",
      value: "",
  ...
  it('associates field with message correctly', function () {
    var _render6 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(PasswordField, {
      id: "field",
      label: "My field",
      message: "Required",
      value: "",
  ...
  it('associates field with description correctly', function () {
    var _render7 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(PasswordField, {
      id: "field",
      label: "My field",
  ...
  it('associates field with custom description correctly', function () {
    var _render8 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, _span || (_span = /*#__PURE__*/_jsx("span", {
      id: "detail"
    }, void 0, "Custom description")), /*#__PURE__*/_jsx(PasswordField, {
      id: "field",
      label: "My field",
  ...
  it('associates field with multiple description elements correctly', function () {
    var _render9 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, _span2 || (_span2 = /*#__PURE__*/_jsx("span", {
      id: "detail"
    }, void 0, "Custom description")), /*#__PURE__*/_jsx(PasswordField, {
      id: "field",
      label: "My field",
  ...
  it('field is not marked as having a description without a message or description', function () {
    var _render10 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(PasswordField, {
      id: "field",
      label: "My field",
      value: "",
      onChange: function onChange() {}
  ...
  it('field should be marked as disabled when disabled', function () {
    var _render11 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(PasswordField, {
      id: "field",
      label: "My field",
      value: "",
      onChange: function onChange() {},
