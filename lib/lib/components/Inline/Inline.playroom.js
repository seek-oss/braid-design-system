...
var _excluded = ["space", "align", "alignY", "component"];
...
export var Inline = function Inline(_ref) {
  ...
  return /*#__PURE__*/React.createElement(BraidInline, _extends({
    ...
    component: component && validInlineComponents.indexOf(component) > -1 ? component : undefined
  }, restProps));
};
