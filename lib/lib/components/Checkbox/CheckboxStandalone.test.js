...
describe('CheckboxStandalone', function () {
  it('associates field with label correctly', function () {
    var _render = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(CheckboxStandalone, {
      id: "field",
      "aria-label": "My field",
  ...
  it('associates field with external label correctly', function () {
    var _render2 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, _h || (_h = /*#__PURE__*/_jsx("h3", {
      id: "other"
    }, void 0, "Other field")), /*#__PURE__*/_jsx(CheckboxStandalone, {
      id: "field",
  ...
  it('should communicate the checked state to a screen reader', function () {
    var _render3 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(CheckboxStandalone, {
      id: "field",
      "aria-label": "My field",
      onChange: function onChange() {},
      checked: true
  ...
  it('should communicate the unchecked state to a screen reader', function () {
    var _render4 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(CheckboxStandalone, {
      id: "field",
      "aria-label": "My field",
      onChange: function onChange() {},
      checked: false
  ...
  it('should communicate the mixed state to a screen reader', function () {
    var _render5 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(CheckboxStandalone, {
      id: "field",
      "aria-label": "My field",
      onChange: function onChange() {},
      checked: "mixed"
  ...
  it('should toggle state correctly when controlled field is initialised to `mixed`', function () {
    var TestCase = function TestCase() {
      ...
      return /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(CheckboxStandalone, {
        id: "field",
        "aria-label": "My field",
    ...
    var _render6 = render( /*#__PURE__*/_jsx(TestCase, {})),
        getByRole = _render6.getByRole;

    var checkboxStandalone = getByRole('checkbox');
  ...
  it('should not toggle state when forced to `mixed`', function () {
    var _render7 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(CheckboxStandalone, {
      id: "field",
      "aria-label": "My field",
      onChange: function onChange() {},
      checked: "mixed"
  ...
  it('should resolve to `mixed` when mixed checked values are provided and the last is `false`', function () {
    var _render8 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(CheckboxStandalone, {
      id: "field",
      "aria-label": "My field",
      onChange: function onChange() {},
  ...
  it('should resolve to `mixed` when mixed checked values are provided and the last is `true`', function () {
    var _render9 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(CheckboxStandalone, {
      id: "field",
      "aria-label": "My field",
      onChange: function onChange() {},
  ...
  it('should resolve to checked when all values provided are `true`', function () {
    var _render10 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(CheckboxStandalone, {
      id: "field",
      "aria-label": "My field",
      onChange: function onChange() {},
  ...
  it('should resolve to unchecked when all values provided are `false`', function () {
    var _render11 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(CheckboxStandalone, {
      id: "field",
      "aria-label": "My field",
      onChange: function onChange() {},
  ...
  it('should resolve to unchecked when an empty array is provided', function () {
    var _render12 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(CheckboxStandalone, {
      id: "field",
      "aria-label": "My field",
      onChange: function onChange() {},
      checked: []
