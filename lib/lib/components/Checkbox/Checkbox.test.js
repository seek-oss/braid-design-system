...
describe('Checkbox', function () {
  it('associates field with label correctly', function () {
    var _render = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
      id: "field",
      label: "My field",
  ...
  it('associates field with message correctly', function () {
    var _render2 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
      id: "field",
      label: "My field",
      message: "Required",
      onChange: function onChange() {},
  ...
  it('associates field with description correctly', function () {
    var _render3 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
      id: "field",
      label: "My field",
  ...
  it('associates field with multiple description elements correctly', function () {
    var _render4 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
      id: "field",
      label: "My field",
      message: "Required",
      description: "More detail about field",
    ...
    expect(getByLabelText('My field')).toHaveDescription('Required More detail about field');
  });
  it('field is not marked as having a description without a message or description', function () {
    var _render5 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
      id: "field",
      label: "My field",
      onChange: function onChange() {},
      checked: false
  ...
  it('should communicate the checked state to a screen reader', function () {
    var _render6 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
      id: "field",
      label: "My field",
      onChange: function onChange() {},
      checked: true
  ...
  it('should communicate the unchecked state to a screen reader', function () {
    var _render7 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
      id: "field",
      label: "My field",
      onChange: function onChange() {},
      checked: false
  ...
  it('should communicate the mixed state to a screen reader', function () {
    var _render8 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
      id: "field",
      label: "My field",
      onChange: function onChange() {},
      checked: "mixed"
  ...
  it('should toggle state correctly when controlled field is initialised to `mixed`', function () {
    var TestCase = function TestCase() {
      var _useState = useState('mixed'),
          _useState2 = _slicedToArray(_useState, 2),
          checked = _useState2[0],
          setChecked = _useState2[1];

      return /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
        id: "field",
        label: "My field",
    ...
    var _render9 = render( /*#__PURE__*/_jsx(TestCase, {})),
  ...
  it('should not toggle state when forced to `mixed`', function () {
    var _render10 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
      id: "field",
      label: "My field",
      onChange: function onChange() {},
      checked: "mixed"
  ...
  it('should resolve to `mixed` when mixed checked values are provided and the last is `false`', function () {
    var _render11 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
      id: "field",
      label: "My field",
      onChange: function onChange() {},
  ...
  it('should resolve to `mixed` when mixed checked values are provided and the last is `true`', function () {
    var _render12 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
      id: "field",
      label: "My field",
      onChange: function onChange() {},
  ...
  it('should resolve to checked when all values provided are `true`', function () {
    var _render13 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
      id: "field",
      label: "My field",
      onChange: function onChange() {},
  ...
  it('should resolve to unchecked when all values provided are `false`', function () {
    var _render14 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
      id: "field",
      label: "My field",
      onChange: function onChange() {},
  ...
  it('should resolve to unchecked when an empty array is provided', function () {
    var _render15 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Checkbox, {
      id: "field",
      label: "My field",
      onChange: function onChange() {},
      checked: []
