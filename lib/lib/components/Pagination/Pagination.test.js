...
describe('Pagination', function () {
  it('should render valid html structure', function () {
    expect(renderToStaticMarkup( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Pagination, {
      page: 1,
      total: 10,
  ...
  it('should have correct document relationships', function () {
    var _render = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Pagination, {
      page: 5,
      total: 10,
      linkProps: function linkProps() {
        return {
    ...
    var previousLink = getByLabelText('Prev');
    var nextLink = getByLabelText('Next');
  ...
  it('should not show the Previous button on the first page', function () {
    var _render2 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Pagination, {
      page: 1,
      total: 10,
      linkProps: function linkProps() {
        return {
  ...
  it('should not show the Next button on the last page', function () {
    var _render3 = render( /*#__PURE__*/_jsx(BraidTestProvider, {}, void 0, /*#__PURE__*/_jsx(Pagination, {
      page: 8,
      total: 8,
      linkProps: function linkProps() {
        return {
