...
A user avatar that can show a photo, initials derived from `name`, or an icon. Available in `small`, `standard`, `large` and `xlarge` sizes, with `loading` and photo error states.
