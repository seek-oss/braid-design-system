...
import { palette as joraPalette } from '../../color/joraPalette';
...
export const makeTokens = ({
  ...
  const formAccent = palette.green['600'];
  const critical = joraPalette.red['600'];
  ...
  const tokens: BraidTokens = {
    ...
    border: {
      ...
      color: {
        ...
        critical,
        criticalLight: joraPalette.red['200'],
        ...
        neutralInverted: joraPalette.white,
    ...
    color: {
      ...
      background: {
        ...
        criticalLight: joraPalette.red['100'],
        criticalSoft: joraPalette.red['50'],
        criticalSoftActive: darken(0.05, joraPalette.red['50']),
        criticalSoftHover: darken(0.025, joraPalette.red['50']),
        formAccent,
        formAccentActive: joraPalette.green['800'],
        formAccentHover: joraPalette.green['600'],
