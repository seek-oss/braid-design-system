...
// Helper ID for TabsProvider to fix the undefined id issue
const tabsId = 'tabs-example';
...
export const ActiveIndicatorBasic: Story = {
  ...
  render: () => (
    <Stack space="medium">
      {['1', '2', '3'].map((item) => (
        <TabsProvider id={tabsId} selectedItem={item} key={item}>
...
export const TestSelectedTabScrolledIntoView: Story = {
  ...
  render: () => (
    <TabsProvider id={tabsId} selectedItem="4">
      <Stack space="medium">
        <Tabs label="Test tabs" align="center">
...
export const TestSelectedTabWithGutterScrolledIntoView: Story = {
  ...
  render: () => (
    <TabsProvider id={tabsId} selectedItem="3">
      <Stack space="medium">
