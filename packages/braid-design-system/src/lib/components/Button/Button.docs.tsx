  ...
  docSections: {
    appearance: [
        ...
        description: (
          <Stack space="large">
            <Text>
              ...
              <Strong>variant</Strong> prop accepts either{' '}
              <Strong>solid</Strong>, <Strong>ghost</Strong>,{' '}
              <Strong>soft</Strong> or <Strong>transparent</Strong>. When no
              variant is specified, the button will appear as ghost by default.
            </Text>
      ...
      },
      {
        ...
        description: (
          <Text>
            ...
            <Strong>critical</Strong> or <Strong>neutral</Strong>. When no tone
            is specified, the button will appear as neutral by default.
          </Text>
        ),
      },
      {
      ...
      },
      {
        description: (
          <Stack space="large">
            ...
            <Text>
              Avoid using multiple critical buttons in the same group of
              buttons. Multiple critical buttons may appear on the same page but
              should relate to different pieces of content.
            </Text>
          </Stack>
        ),
        Example: () =>
      ...
      },
      {
        ...
        description: (
          <Text>
            For differentiation and to help communicate the purpose of the
            button, an <Strong>icon</Strong> can be provided.
          </Text>
        ),
        Example: () => {
          const { value: visual } = source(
        ...
        description: (
          <>
            <Text>
              ...
              foreground colour to improve contrast against a dark background.
              To compliment this, the hover and active backgrounds remove the
              colour in favour of a white translucency.
            </Text>
            <Notice>
              <Text>
            ...
            <Text>
              ...
              behaviour can be applied by setting the{' '}
              <Strong>background</Strong> to either <Strong>customLight</Strong>{' '}
              or <Strong>customDark</Strong>.
            </Text>
          </>
        ),
        background: 'neutral',
    ...
    layout: [
        ...
        description: (
          <>
            ...
            <Text>
              ...
              which handles spacing and responsive behavior automatically. If
              you have specific layout needs, you can also use{' '}
      ...
      },
      {
        description: (
          <Text>
            Avoid displaying multiple solid buttons together with different
            tones applied. If you need to apply more than one tone within a
            group of buttons, apply different variants also to create
        ...
        description: (
          <>
            ...
            <Text>
              ...
              secondary. On tablet and desktop, buttons should align to the
              left. On mobile, buttons should stack at full width with primary
              appearing first.
            </Text>
            <Notice>
              <Text>
                ...
                context of a{' '}
                <TextLink href="/components/Stepper">Stepper</TextLink>. In
                these scenarios, the primary button should align to the right.
                Read more about{' '}
      ...
      },
      {
        description: (
          <Text>
            If you need to position buttons side by side on mobile instead,
            follow the Apps advice below.
          </Text>
        ),
      },
      {
        description: (
          <>
            ...
            <Text>
              ...
              primary on the right, secondary on the left with buttons placed
              side by side, justified to the screen width.
            </Text>
          </>
        ),
        playroom: false,
          ...
          <>
            ...
            <Notice>
              <Text>
                ...
                horizontally to facilitate better alignment with surrounding
                text.
              </Text>
            </Notice>
            <Text>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <Text>
              When designing a form, instead of disabling the submit button when
              a required field is missing, allow the user to attempt to submit
              and fail. Then provide validation feedback informing the user of
      ...
      },
      {
        description: (
          <>
            ...
            <List space="large">
              <Text>
                Be specific. People need to know what to expect when they click
                a button. Button content should make sense even if someone
                doesn&rsquo;t read the content around it e.g. someone using a
                screenreader to jump through the links, someone scanning the
                page or someone with a small visual focus field.
              </Text>
              <Text>
