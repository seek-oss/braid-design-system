    ...
    appearance: [
      {
        ...
        description: (
          <Text>
            For greater contrast, you can set the <Strong>weight</Strong> prop
            to <Strong>strong</Strong>.
          </Text>
        ),
        Example: () =>
          source(
    ...
    layout: [
      {
        ...
        description: (
          <Text>
            When aligning badges inline alongside flowing text, it is
            recommended to place the badge inside the{' '}
      ...
      },
      {
        ...
        description: (
          <Fragment>
            <Text>
              With the <Strong>bleedY</Strong> prop, you can allow the
              background colour to bleed out into the surrounding layout.
            </Text>
            <Text>
              For example, if we consider aligning a badge alongside other
              content in a{' '}
              ...
              declarative and consistent regardless of the presence of the
              badge.
            </Text>
          </Fragment>
        ),
