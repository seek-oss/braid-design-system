          ...
          <Stack space="xlarge">
            <Stack space="small">
              ...
              <Text>
                ...
                recommended to use <Strong>reserveMessageSpace</Strong> to
                prevent the elements shifting when messages appear.
              </Text>

              <Text>
                Uses a <Strong>small Stack</Strong> for fields, with a{' '}
                <Strong>large Stack</Strong> separating the actions from the
                form.
              </Text>
            </Stack>
